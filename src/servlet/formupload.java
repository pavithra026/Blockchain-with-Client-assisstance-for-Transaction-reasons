			     ...
			     filepath1 = editpath + "\\BC05-22\\WebContent\\Encrypt\\"+filename;
			      ...
			      //file decrypted and store into filepath2
					   ...
					   String prehash="";
						...
						con=dbcon.create();
						try {
							PreparedStatement pa=con.prepareStatement("SELECT phash,ahash FROM `bc05-22`.upload` where mail='"+ad+"'");
					   ...
					   uploadbean dvb = new uploadbean();
						...
						dvb.setServices(paramValues.get(4).toString());
						System.out.println("Services  "+paramValues.get(4).toString());
						
						dvb.setCate(paramValues.get(6).toString());
						System.out.println("Services type "+paramValues.get(6).toString());
					   ...
					   int dd=dv.load(dvb);
						if(dd==1)
						{
							response.sendRedirect("sucs.jsp");
						}
						else
						{
