...
public class uploadteambean {
	private String phash,ahash,email,des,services,cate,filename, filetype, filecontent, filesize, encryptionfile, decryptionfile,status,id;
