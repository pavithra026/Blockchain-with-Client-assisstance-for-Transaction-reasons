...
<table class = "table table-bordered">
   ...
   <%
	...
	PreparedStatement p = d.prepareStatement("SELECT * FROM `bc05-22`.bill  where status='paid' and status!='forwarded'");
...
<td><a href="fileshare.jsp?id=<%=s.getString(5) %>" style="color:red;">Share</a></td>
