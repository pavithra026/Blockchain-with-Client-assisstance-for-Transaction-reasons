...
PreparedStatement p = d.prepareStatement("SELECT * FROM `bc05-22`.`apply` where email='"+email+"' and status='upload' ");
...
<center>
<br>
<h2>Upload Service requirement</h2>
<form action="fileuploadteam" method="post" enctype="multipart/form-data">
